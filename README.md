...
Copy environment example Create a .env file based on .env.example (see below). Never commit real keys.
...
Make changes and submit a pull request with tests where appropriate.
...
Audit third-party SDK usage and keep dependencies up-to-date. ye dekh ye he iska readme ab mujhe prompt de
